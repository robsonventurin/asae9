...
<html>
    ...
    <body>
        ...
        <main>
            <div class="container">
                {{ $mensagem }}<br>
                Para cadastrar um novo cliente, clique <a href="{{ route('cadastrar_clientes') }}">aqui</a>.<br>
                Para listar todos os clientes, clique <a href="{{ route('listar_clientes') }}">aqui</a><br>
            </div>
        </main>
